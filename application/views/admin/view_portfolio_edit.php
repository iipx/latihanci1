								...
								<table class="table table-bordered">
									...
									foreach ($all_photos_by_id as $row) {
										...
										<tr>
											...
											<td><a href="#" class="btn btn-danger btn-xs" data-href="<?php echo base_url(); ?>admin/portfolio/single-photo-delete/<?php echo $row['id']; ?>/<?php echo $portfolio['id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a></td>
										</tr>
										<?php
									}
									?>
