							...
							foreach ($slider as $row) {
								...
								<tr>
									...
									<td>										
										...
										<a href="#" class="btn btn-danger btn-xs" data-href="<?php echo base_url(); ?>admin/slider/delete/<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>  
									</td>
								</tr>
								<?php
							}
