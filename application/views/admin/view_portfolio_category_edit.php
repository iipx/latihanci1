...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/portfolio-category" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
  	...
  	<div class="row">
	    <div class="col-md-12">
	       ...
	       <?php echo form_open(base_url().'admin/portfolio-category/edit/'.$portfolio_category['category_id'],array('class' => 'form-horizontal')); ?>
